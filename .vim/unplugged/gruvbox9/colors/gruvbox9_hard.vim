...
" Last Updated: Tue Jul  9 22:23:23 2019
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if get(g:, "gruvbox_plugin_hi_groups", 0)
      ...
      hi WhichKey guifg=#d3869b guibg=NONE guisp=NONE gui=NONE cterm=NONE
      hi WhichKeySeperator guifg=#928374 guibg=NONE guisp=NONE gui=NONE cterm=NONE
      hi! link WhichKeyGroup Keyword
      hi WhichKeyDesc guifg=#fabd2f guibg=NONE guisp=NONE gui=NONE cterm=NONE
      hi WhichKeyFloating guifg=NONE guibg=#504945 guisp=NONE gui=NONE cterm=NONE
      if !s:italics
  ...
  if get(g:, "gruvbox_plugin_hi_groups", 0)
    ...
    hi WhichKey guifg=#8f3f71 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi WhichKeySeperator guifg=#928374 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi! link WhichKeyGroup Keyword
    hi WhichKeyDesc guifg=#b57614 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi WhichKeyFloating guifg=NONE guibg=#d5c4a1 guisp=NONE gui=NONE cterm=NONE
    if !s:italics
      hi deniteMode gui=NONE cterm=NONE
    endif
    let g:vimshell_escape_colors = [
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    if get(g:, "gruvbox_plugin_hi_groups", 0)
      ...
      hi WhichKey ctermfg=175 ctermbg=NONE cterm=NONE
      hi WhichKeySeperator ctermfg=102 ctermbg=NONE cterm=NONE
      hi! link WhichKeyGroup Keyword
      hi WhichKeyDesc ctermfg=214 ctermbg=NONE cterm=NONE
  ...
  if get(g:, "gruvbox_plugin_hi_groups", 0)
    ...
    hi WhichKey ctermfg=126 ctermbg=NONE cterm=NONE
    hi WhichKeySeperator ctermfg=102 ctermbg=NONE cterm=NONE
    hi! link WhichKeyGroup Keyword
    hi WhichKeyDesc ctermfg=172 ctermbg=NONE cterm=NONE
    hi WhichKeyFloating ctermfg=NONE ctermbg=187 cterm=NONE
    let g:vimshell_escape_colors = [
          \ '#a89984', '#9d0006', '#79740e', '#b57614',
          \ '#076678', '#8f3f71', '#427b58', '#7c6f64',
          \ '#f9f5d7', '#9d0006', '#79740e', '#af3a03',
